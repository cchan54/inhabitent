...
function latest_adventures() {

	$labels = array(
		'name'                  => 'Latest Adventures',
		'singular_name'         => 'Latest Adventure',
	...
	register_post_type( 'latest_adventures', $args );

}
add_action( 'init', 'latest_adventures', 0 );