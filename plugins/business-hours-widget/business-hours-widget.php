 ...
 * @author    Cliff Chan <cchan17@live.ca>
 * @license   GPL-2.0+
 * @link      https://github.com/cchan54/
 * @copyright 2018 Cliff Chan
 *
 * @wordpress-plugin
 * Plugin Name:       Business Hours Widget
 * Plugin URI:        https://github.com/cchan54/
 * Description:       Business Hours Widget, Business Hours
 * Version:           1.0.1
 * Author:            Cliff Chan
 * Author URI:        https://github.com/cchan54/
 * License:           GPL-2.0+
	...
	public function __construct() {
		...
		parent::__construct(
			...
			array(
				...
				'description' => 'Add stores business hours'
			)
		);
